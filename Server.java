...
public class Server extends JFrame { // By extending JFrame, the "Client" class inherits all the properties and
// methods of JFrame,
// allowing you to customize and create your own window-based application using
// Swing components.

    ServerSocket server; // Variable of Server
    Socket socket; // Variable of Client
    ...
    private JLabel heading = new JLabel("Server Area"); // Heading of GUI
    ...
    public Server() {
        ...
        try {
            ...
            // To accept the request from client
    ...
    private void createGUI() {
        ...
        this.setTitle("Server Messager"); // Heading or Title shown on Windows Frame
        ...
        heading.setIcon(new ImageIcon("ss.png")); // To show logo in Frame
            ...
            try {
                ...
                while (true) {
                    ...
                    if (msg.equals("exit")) {
                        ...
                        JOptionPane.showMessageDialog(this, "Client terminated the chat"); // Displays a dialog box with
                                                                                           // the message "Server
                                                                                           // terminated the chat,"
        ...
        Runnable r2 = () -> {
            ...
            try {
                ...
                while (!socket.isClosed()) {
                    ...
                    // To print
                    out.println(content);
                    out.flush(); // `out.flush()` is a method used to force any buffered data in the output stream to be written immediately to its destination,
                                 // ensuring that the data is not held in the buffer and is made available for consumption or storage.
                ...
                //e.printStackTrace(); // e.printStackTrace(); // e.printStackTrace() is a method in Java that is used to print the stack trace of an exception.
                //It is commonly used for debugging purposes to identify the cause of an exception and to trace the sequence of method calls that led to the exception.
